...
def train(model, train_loader, criterion, optimizer, scheduler, num_epochs=30):
    ...
    for epoch in range(num_epochs):
        ...
        print(f'Epoch [{epoch+1}/{num_epochs}], Loss: {epoch_loss:.4f}, Accuracy: {epoch_acc:.2f}%, LR: {scheduler.get_last_lr()[0]:.6f}')
...
def main():
    ...
    test_dataset = MNISTDataset('digit-recognizer/test.csv', train=False)
    ...
    print('Sample submission saved to digit-recognizer/sample_submission.csv')
